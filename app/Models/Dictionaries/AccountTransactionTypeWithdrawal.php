 ...
 * @property int $sign
 */
class AccountTransactionTypeWithdrawal extends AccountTransactionType implements AsDictionary
{
    /**
    ...
    {
        return self::query()->where('parent_type_id', self::account_withdrawal);
    }
