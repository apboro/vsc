...
use App\Http\Controllers\API\Contracts\ContractsDeleteController;
...
Route::post('/contracts/delete', [ContractsDeleteController::class, 'delete'])->middleware('role:super');
