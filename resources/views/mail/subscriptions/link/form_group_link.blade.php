...
Нам с Вами осталось заполнить договор, перейдя по ссылке: , чтобы мы могли начать тренировочные мероприятия и соревнования:{{ route('leads_group.subscription.contract.fill', ['sbsc' => Crypt::encrypt($subscription->id)]) }}
