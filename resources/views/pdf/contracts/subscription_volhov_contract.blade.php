...
<p>2.1.1. Обеспечить проживание Ребенка на период проведения. тренировочных сборов с <b>{{ $service_start_date }}</b> г. по <b>{{ $service_end_date }}</b> г. в гостинице «<b>{{ $training_base_name }}</b>», расположенной по адресу: <b>{{ $training_base_address }}</b> </p>
...
<p>2.1.4. Обеспечить охрану здоровья и безопасность пребывания Ребенка на тренировочных сборах в период с <b>{{ $service_start_date }}</b> г. по <b>{{ $service_end_date }}</b> г.</p>
