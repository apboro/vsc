...
<script>
import LeadDatePicker from "@/Pages/Leads/Components/Inputs/Helpers/LeadDatePicker.vue";
import LeadIconCross from "@/Pages/Leads/Components/Icons/LeadIconCross.vue";

export default {
    components: {LeadIconCross, LeadDatePicker},
