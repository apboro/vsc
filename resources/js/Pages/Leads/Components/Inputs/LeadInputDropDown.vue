<template>
    <LeadInputWrapper class="input-dropdown" :dirty="isDirty" :disabled="disabled" :valid="valid" :has-focus="dropped" :label="false"
    ...
    >
        ...
        <span class="input-dropdown__toggle" :class="{'input-dropdown__toggle-expanded': dropped}" @click.capture="toggle"><LeadIconDropdown/></span>
        ...
        >
            <div class="input-dropdown__list-search" v-if="search">
                <LeadInputSearch v-model="terms" @change="updateHeight" @click.stop="false" ref="search"/>
            </div>
...
import LeadInputSearch from "@/Pages/Leads/Components/Inputs/LeadInputSearch.vue";
import LeadIconDropdown from "@/Pages/Leads/Components/Icons/LeadIconDropdown.vue";
...
export default {
    ...
    components: {LeadIconDropdown, LeadInputSearch, LeadInputWrapper},
...
.input-dropdown {
    ...
    &__values {
        ...
        &-item {
            ...
            height: $base_size_unit - 10px !important;
            box-sizing: border-box;
            border-radius: 4px;
            margin: 2px;
            padding: 0 0 0 8px;
            ...
            &-remove {
                ...
                width: math.div($base_size_unit, 2) !important;
                height: 100%;
                cursor: pointer;
                margin: 0 0 0 2px;
                position: relative;
    ...
    &__list {
        ...
        left: -1px;
        max-height: $base_size_unit * 8 !important;
        ...
        &-item {
            ...
            line-height: $base_size_unit * 0.5 !important;
            padding: 4px 10px;
