...
import NewLeadGroup from "@/Pages/Leads/NewLeadGroup";
import LoadingProgress from "@/Components/LoadingProgress";
import GroupContractForm from "@/Pages/Leads/GroupContractForm";
import GuiMessage from "@/Components/GUI/GuiMessage";

export default {
    components: {GuiMessage, GroupContractForm, LoadingProgress, NewLeadGroup, GuiContainer},
    props: {
    ...
    created() {
        ...
        axios.post(this.url('/leads-group/init'), {subscription_key: this.subscriptionKey}, {headers: {'X-Vsc-Key': this.key}})
            .then(response => {
